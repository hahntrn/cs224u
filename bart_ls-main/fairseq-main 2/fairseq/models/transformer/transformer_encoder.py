...
from fairseq.models.pooling_layer import PoolEncoderLayer
...
class TransformerEncoderBase(FairseqEncoder):
    ...
    def __init__(self, cfg, dictionary, embed_tokens, return_fc=False):
        ...
        self.layers.extend(
            [self.build_encoder_layer(cfg) for i in range(cfg.encoder.layers - 4)]
        )
        self.layers.extend(
            [PoolEncoderLayer(cfg) for i in range(4)]
        )
